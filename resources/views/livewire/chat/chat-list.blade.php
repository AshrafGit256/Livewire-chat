<div x-data="{ type: 'all' }" class="flex flex-col transition-all h-full overflow-hidden">
    <header class="px-3 z-10 bg-white sticky top-0 w-full py-2">
        ...
        <div class="flex gap-3 items-center overflow-x-scroll-hidden p-2 bg-white">
                    ...
                    <a href="#" class="col-span-11 border-b pb-2 border-gray-300 relative overflow-hidden truncate leading-5 w-full flex-nowrap p-1">
                        ...
                        <div class="flex gap-x-2 items-center">
                            ...
                            <p class="grow truncate text-sm font-[100]">
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Debitis adipisci aliquid, deleniti a quidem ex architecto aspernatur obcaecati impedit tempora optio at inventore velit pariatur sint laboriosam tempore! Fugiat, et!
                            </p>
                        ...
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <div class="w-full p-1">
                                    ...
                                    <button class="items-center gap-3 flex w-full px-4 py-2 text-left text-sm leading-5 text-gray-100 hover:bg-gray-400 transition-all duration-150 ease-in-out focus:outline-none focus:bg-gray-100">
